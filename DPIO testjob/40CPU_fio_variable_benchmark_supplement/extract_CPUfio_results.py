...
# 输入目录和输出文件（请根据实际路径修改）
input_dir = r"C:\Users\jackey_gu\Desktop\脚本\DPIO\DPIO testjob\40CPU_fio_variable_benchmark_supplement"
output_csv = r"C:\Users\jackey_gu\Desktop\脚本\DPIO\DPIO testjob\40CPU_fio_variable_benchmark_supplement\40CPUsupplement_summary.csv"
