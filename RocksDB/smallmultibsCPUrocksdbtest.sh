...
# ===================================================================
# NVMeoF + RocksDB 性能测试脚本（最终定稿版 - 写入性能与读取靶场解耦）
# 逻辑：每个块大小循环内，先60秒测写性能 -> 清空 -> 填充15万条靶数据 -> 测读与混合
# ===================================================================

# === 配置区 ===
CPU_CORE=1                                
DEVICE_NAME="nvme3n1"                     
PARTITION="/dev/nvme3n1"                  
MOUNT_POINT="/mnt/nvmeof"                 
DB_PATH="${MOUNT_POINT}/rocksdb_bench"    
DB_BENCH="/home/gwh/filebench/rocksdb-main/db_bench"        
LOG_DIR="/home/gwh/DPIO/rocksdb/small_multibs_CPU_rocksdbnvmeof_perf_logs" 
