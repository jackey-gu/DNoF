...
# === 配置区 ===
CPU_CORE=1                                # 绑定到 CPU1
DEVICE_NAME="nvme4n1"                     # 你的 NVMeoF 设备名
PARTITION="/dev/nvme4n1"         # 若未分区，请改为 /dev/nvme4n1 PARTITION="/dev/${DEVICE_NAME}p1"   
...
LOG_DIR="/home/gwh/DPIO/rocksdb/CPU_rocksdbnvmeof_perf_logs"          # 日志保存目录
