...
# ================== 配置区 ==================
csv_file = r"C:\Users\jackey_gu\Desktop\脚本\DPIO\DPoF\DPU_nvmeof_8DPUsupplement_summary.csv"
output_dir = r"C:\Users\jackey_gu\Desktop\脚本\DPIO\DPoF\DPU_nvmeof_8CPU_fio_variable_benchmark_supplement\fio_plots_supplement"
...
# ✅ 修改：只到 8
test_order = [str(i) for i in range(1, 9)]  # CPU 数量 1~8
...
def plot_metric(df, test_type_key, x_field, metric_name, y_cols, ylabel):
    ...
    # ✅ 修改：更准确的标题和 X 轴标签
    ax.set_title(f"{metric_name} vs {test_type_key.upper()}", fontsize=14)
    ax.set_xlabel("Number of CPUs", fontsize=12)  # ✅ 关键修改
